--select compatibility_level from sys.databases where name = 'DB_A1595D_DoctorMedicalWeb'
...
--ALTER DATABASE [DB_A1595D_DoctorMedicalWeb]
--SET COMPATIBILITY_LEVEL = 110;
--GO

--SELECT compatibility_level
--FROM sys.databases WHERE name = N'DB_A1595D_DoctorMedicalWeb';
--GO

--url donde busque la informacion que me ayudo a cambiar la compatibilidad a 110 desde 120

--https://weblogs.asp.net/dixin/visual-studio-entity-data-model-wizard-not-responding